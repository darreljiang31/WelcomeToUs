            ...
            <Container style={{height: 170, backgroundColor: 'rgba(0,0,0,0.0)'}}>
              <Container style={{backgroundColor: 'rgba(0,0,0,0.0)'}}>
                <Label style={{left: 30, backgroundColor: 'rgba(0,0,0,0.0)', color:'#D4D4D4'}}>City:</Label>
                  <Input
                    placeholder="City"
                    style={{top: -27, left: 110, borderWidth: .5, height: 30, backgroundColor: 'rgba(0,0,0,0.0)', borderColor: '#FEB51E', width: 225, color:'#D4D4D4'}}
                  />
              </Container>
              <Container style={{backgroundColor: 'rgba(0,0,0,0.0)'}}>
                <Label style={{top: 5, left: 30, color:'#D4D4D4'}}>Zip Code:</Label>
                  <Input
                    ...
                    style={{top: -19, left: 110, borderWidth: .5, height: 30, borderColor: '#FEB51E', width: 225, color:'#D4D4D4'}}
                  />
              </Container>
             <DoubleButton
              text1="CONTINUE"
